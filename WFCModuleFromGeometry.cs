...
namespace WFCTools
{
    ...
    public class WFCModuleFromGeometry : GH_Component
    {
        public WFCModuleFromGeometry() : base("WFC Create module from geometry", "WFCModuleGeo",
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            pManager.AddTextParameter("Name", "N", "Module name (except '" + WFCUtilities.EMPTY_MODULE_NAME + "' and '" + WFCUtilities.OUTER_MODULE_NAME + "')", GH_ParamAccess.item);
        ...
        {
            pManager.AddParameter(new WFCModuleParameter(), "Module", "M", "WFC Module", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            foreach (var goo in geometryClean)
            {
                ...
                if (geo.Transform(normalizationTransform) && geo.Transform(worldAlignmentTransform))
                {
                    ...
                    var populatePoints = WFCUtilities.PopulateGeometry(divisionLength, geo);
            ...
            var module = new WFCModule(name, geometryClean, basePlane, submoduleCenters, slotDiagonal);
