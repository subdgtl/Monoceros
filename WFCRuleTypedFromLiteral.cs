...
namespace WFCTools
{
    ...
    public class WFCRuleTypedFromLiteral : GH_Component
    {
        public WFCRuleTypedFromLiteral() : base("WFC Create typed rule from literal", "WFCRuleTypLit",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var rule = new WFCRule(moduleName, connector, type);
