...
namespace WFCTools
{
    ...
    public class WFCRuleExplicitFromLiteral : GH_Component
    {
        public WFCRuleExplicitFromLiteral() : base("WFC Create explicit rule from literal", "WFCRuleExpLit",
        ...
        {
            pManager.AddParameter(new WFCRuleParameter(), "Rule", "R", "WFC Rule", GH_ParamAccess.item);
        }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var rule = new WFCRule(sourceName, sourceConnector, targetName, targetConnector);
