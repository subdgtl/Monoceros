...
namespace WFCTools
{
    ...
    /// </summary>
    public class WFCModule : IGH_Goo, IGH_PreviewData
    {
        ...
        /// </summary>
        public readonly List<WFCRuleExplicit> InternalRules;
        ...
        public WFCModule(string name, List<GeometryBase> geometry, Plane basePlane, List<Point3i> submoduleCenters, Vector3d slotDiagonal)
        {
        ...
        private List<WFCRuleExplicit> ComputeInternalRules(List<Point3i> submoduleCenters)
        {
            var rulesInternal = new List<WFCRuleExplicit>();
            ...
            for (int thisIndex = 0; thisIndex < submoduleCenters.Count; thisIndex++)
            {
                ...
                {
                    rulesInternal.Add(new WFCRuleExplicit(Name, thisIndex * 6 + 0, Name, otherIndexXPositive * 6 + 3));
                    continue;
                }
                ...
                {
                    rulesInternal.Add(new WFCRuleExplicit(Name, thisIndex * 6 + 1, Name, otherIndexYPositive * 6 + 4));
                    continue;
                }
                ...
                {
                    rulesInternal.Add(new WFCRuleExplicit(Name, thisIndex * 6 + 2, Name, otherIndexZPositive * 6 + 5));
                    continue;
                }
            }
        ...
        public static void GenerateNamedEmptySingleModule(string name, string connectorType, Vector3d slotDiagonal, out WFCModule module, out List<WFCRuleTyped> rulesExternal)
        {
            module = new WFCModule(
                name,
            ...
            rulesExternal = new List<WFCRuleTyped>(6);
            for (int i = 0; i < 6; i++)
            {
                rulesExternal.Add(new WFCRuleTyped(name, i, connectorType));
            }
        }
