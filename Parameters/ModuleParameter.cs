...
namespace Monoceros {
    ...
    /// <summary>
    /// Wraps <see cref="Module"/> type so that it can be used in Grasshopper as
    ...
    public class ModuleParameter : GH_PersistentParam<Module>, IGH_PreviewObject, IGH_BakeAwareObject {
      ...
      : base("Module", "M", "Contains a collection of Monoceros Modules.", "Monoceros", "Parameters") { }
        ...
        protected override System.Drawing.Bitmap Icon => Properties.Resources.module_parameter;
