...
namespace WFCPlugin
{
    ...
    /// the World.  The <see cref="ComponentFauxSolver"/> encapsulates the
    ...
    public class Slot : IGH_Goo, IGH_PreviewData, IGH_BakeAwareObject
    {
        ...
        ///             <see cref="ComponentFauxSolver"/>. The solution is
        ...
        public override string ToString()
        {
            ...
            return "Slot contains " + containment + ". Center at " + pt + ", base plane at " +
                plane + " with dimensions " + diagonal + ".";
        }
